...
export default function CreateAccountDialog({ open, handleCancel, handleSubmit }: LoginProps) {
  ...
  useEffect(() => {
    if (open) {
      setReqLabels(['User Name', 'Password', 'First Name', 'Last Name']);
      setReqProps(['username', 'password', 'first_name', 'last_name']);
      setReqFields([]);
    }
  }, [open]);
        ...
        <DialogContent>
          <Grid container spacing={2} sx={{ marginTop: '10px' }}>
            ...
            <Grid item xs={12}>
              <TextField
                name="first_name"
                error={loginData.first_name_error}
                required
                margin="dense"
                fullWidth
                label="First Name"
            ...
            <Grid item xs={12}>
              <TextField
                name="last_name"
                error={loginData.last_name_error}
                required
                margin="dense"
                fullWidth
                label="Last Name"
